...
class Momentum_Budget:
    def __init__(self, path, dim,  budget, parameter, value):
        ...
        print ("path in three momentum budget = \t", sol)
        ...
        print ("Momentum budget time frames = \t", T)
...
#                bouyMdt   = readfield(sol, tread[k+1], 'bouy_mixd', structured = True, precision = prec)
    ...
    ##### Storage terms 
            ...
            #if int(time[k]) == 6:
                #print ("Acol = \t", np.amax(Inte_A))
                #print ("Acol = \t", np.amax(Inte_Adt))
                #print ("Storage = \t", np.amax(Inte_Adt - Inte_A))
    ...
    ############## flux due to nonlinear term
            ...
            #if int(time[k])==5:
             #   print ("uxux = \t", np.amax(uxux))
              #  print ("uxuxdt = \t", np.amax(uxuxdt))
            ...
            #if int(time[k])==5:
             #   print ("inte_uxux = \t", np.amax(inte_uxux))
              #  print ("inte_uxux = \t", np.amin(inte_uxux))
               # print ("inte_uxuxdt = \t", np.amax(inte_uxuxdt))
                #print ("inte_uxuxdt = \t", np.amin(inte_uxuxdt))
             #   print ("deri_uxux = \t", np.amax(BI.x_deri(inte_uxux, x )))# + BIdt.x_deri(inte_uxuxdt, x))))
              #  print ("deri_uxux = \t", np.amin(BI.x_deri(inte_uxux, x )))# + BIdt.x_deri(inte_uxuxdt, x))))
                #print ("deri_uxux = \t", np.amin((BI.x_deri(inte_uxux, x ) + BIdt.x_deri(inte_uxuxdt, x))))
                #print ("deri_uxuxdt = \t", np.amax(BIdt.x_deri(inte_uxuxdt, x)))
    ...
    ############ Variables at the top and bottom of control volume
            ...
            #if int(time[k]) == 5:
             #   print ("uxuy_b = \t", np.amax(uxuy_b))
              #  print ("uxuy_b = \t", np.amin(uxuy_b))
               # print ("uxuy_b = \t", np.amax(uxuy_h))
                #print ("uxuy_b = \t", np.amin(uxuy_h))
                #print ("uxuy_b = \t", np.amax(uxuydt_b))
                #print ("uxuy_b = \t", np.amin(uxuydt_b))
                #print ("uxuy_b = \t", np.amax(uxuydt_h))
                #print ("uxuy_b = \t", np.amin(uxuydt_h))
    ...
    ################# pressure term
            ...
            if int(time[k])==5:
                print ("Max value of pressure = \t", P.shape) 
                print ("Max value of pressure = \t", np.amax(P[:, :, :]) )
                print ("Max value of pressure = \t", np.amin(P[:, :, :]) )
            ...
            #if int(time[k])==5:
             #   print ("xderi P = \t", np.amax(xderi_inte_P))
              #  print ("xderi P = \t", np.amin(xderi_inte_P))
    ...
    ############### other technique for pressure
       ...
       #     if int(time[k])==5:
        #        print ("xder_Press = \t", np.amax(xder_Press))
         #       print ("xder_Press = \t", np.amin(xder_Press))
          #      print ("xder_Press = \t", np.amax(xder_Pressdt))
           #     print ("xder_Press = \t", np.amin(xder_Pressdt))

            #print ("xder_Press = \t", max(xder_Press))

            inte_xderi_P = (BI.Integrate_flux(xder_Press, Yb, bed_l, bed_h) + BIdt.Integrate_flux(xder_Pressdt, Yb, beddt_l, beddt_h))/2.
        
            #if int(time[k])==5:
             #   print ("inte_xderi_P = \t", np.amax(inte_xderi_P))
              #  print ("inte_xderi_P = \t", np.amin(inte_xderi_P))
    ...
    ############ Stress calculations
            ...
            #if int(time[k])==5:
             #   print ("inte tau_xx = \t", np.amax(inte_tau_xx_total))
              #  print ("inte tau_xx = \t", np.amin(inte_tau_xx_total))
                #print ("tauB = \t", tauB[0, :, :, :])
            ...
            #if int(time[k])==5:
             #   print ("deri tau xx = \t", np.amax(deri_tau_xx))
              #  print ("deri tau xx = \t", np.amin(deri_tau_xx))
    ...
    ################ Stress at the top and bottom
            ...
            #if int(time[k]==5):
             #   print ("tauxy_b = \t", np.amax(tauxy_b))
             #   print ("tauxy_b = \t", np.amin(tauxy_b))
             #   print ("tauxy_b = \t", np.amax(tauxy_h))
             #   print ("tauxy_b = \t", np.amin(tauxy_h))
              #  print ("tauxy_b = \t", np.amax(tauxydt_b))
              #  print ("tauxy_b = \t", np.amin(tauxydt_b))
              #  print ("tauxy_b = \t", np.amax(tauxydt_h))
  #              print ("tauxy_b = \t", np.amin(tauxydt_h))
...
#print ("tauxy_h = \t", bed_h)
            ...
            #if int(time[k])==5:
             #  print ("tauxy b = \t", np.amax(tauxy_b))
              # print ("tauxy b = \t", np.amin(tauxy_b))
              # print ("tauxy b = \t", np.amax(tauxy_h))
              # print ("tauxy b = \t", np.amin(tauxy_h))
   ...
   #         write_hdf5("output_2D/Storage_%g.h5"%(time[k]), Storage)
    #        write_hdf5("output_2D/flux_xx_%g.h5"%(time[k]), flux_uxux)
     #       write_hdf5("output_2D/uxuy_b_%g.h5"%(time[k]), uxuy_bf)
      #      write_hdf5("output_2D/uxuy_h_%g.h5"%(time[k]), uxuy_hf)
        #    write_hdf5("output_2D/xderi_inte_P_%g.h5"%(time[k]), xderi_inte_P)
         #   write_hdf5("output_2D/inte_xderi_P_%g.h5"%(time[k]), inte_xderi_P)
          #  write_hdf5("output_2D/xderi_tau_xx_%g.h5"%(time[k]), deri_tau_xx)
           # write_hdf5("output_2D/tau_xy_b_%g.h5"%(time[k]), tauxy_bf)
            #write_hdf5("output_2D/tau_xy_h_%g.h5"%(time[k]), tauxy_hf)
