...
class Momentum_Budget:
    ...
    ##### Storage terms 
            ...
            #print ("Inte_Adt = \t", Inte_Adt)
#            print ("Inte_Adt = \t", Inte_Adt)

            ############## flux due to nonlinear term

            Inte_B = np.zeros(n1d)
            Inte_Bdt = np.zeros(n1d)
            Bflux = np.zeros(n1d)
            ...
            #print ("Fpres_l = \t", FInte_Pres)
            #print ("Fpres_h = \t", FPressflux)
            ...
            #print ("dybdx_TauP_l = \t", TauxyP_l)
            #print ("dybdx_TauP_h = \t", TauxyP_h)
...
#            print ("dybdx_TauF_l = \t", TauxyF_l)
#            print ("dybdx_TauF_h = \t", TauxyF_h)
